...
class StatisqueController extends Controller
{
    public function index()
    {
        ...
        return view ('statistique.statistique',['formation'=>$formation, 'referentiel'=>$referentiel, 'candidat_total'=>$candidat_total,
